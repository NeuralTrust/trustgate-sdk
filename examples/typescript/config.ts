 ...
 * SDK already reads them from TRUSTGATE_URL and TRUSTGATE_API_KEY. This only
 * adds the part the SDK cannot: saying which variable is missing, and where to
 * find its value, instead of failing on the first request.
 *
